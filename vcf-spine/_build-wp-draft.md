...
This post is the whole story of clearing that wall — start to finish, nothing else. It turned into a multi-day detour through the physical underlay and a from-scratch NSX edge build, and I grabbed a screenshot at every screen so you can follow the diagnosis and the fix end to end. (The routine part — standing up the workload domain in the wizard — gets its own post ; this one is purely about the failure and the fix.)
...
![vCenter datastore view showing VMFS01, a 10 TB VMFS 6 datastore with 8.42 TB free — where the edge appliances deploy](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-008-datastore-vmfs01-scaled.jpg)

![Distributed port group humbledgeeks-cl01-vds01-pg-vm-mgmt on VLAN 16, the management network the edge appliances land on](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-005-portgroup-vm-mgmt-vlan16-scaled.jpg)
...
![VCF workload domain wizard at the vSphere Supervisor step showing an empty VPC Connectivity Profile dropdown, a red error, and a disabled NEXT button](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-004-supervisor-vpc-profile-empty-scaled.jpg)
...
![NSX Manager Overview dashboard before the build: 0 Tier-0 Gateways, 0 External Connections, 0 Segments, and a single empty Transit Gateway](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-001-nsx-overview-before-scaled.jpg)
...
![Default Transit Gateway summary showing Connectivity Not Set, 0 External Connections, 0 Connected VPCs](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-002-transit-gateway-empty-shell-scaled.jpg)

And the VPC "Get Started" page says the quiet part out loud — step one, *Setup Network Connectivity*, had never been done:

![VPC Get Started page in vCenter showing Setup Network Connectivity as an incomplete first step](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-003-vpc-get-started-scaled.jpg)
...
![Meraki dashboard showing four switches online: two MS350-48 Core and two MS425-32 in STACK 40GB](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-010-meraki-switches-online-scaled.jpg)

![Meraki Switch Stacks page showing the Core stack and the STACK 40GB stack, each with two members](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-011-meraki-switch-stacks-scaled.jpg)
...
![Meraki switch settings showing the default MTU configured to 9578 for jumbo frames](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-013-meraki-mtu-9578-jumbo-scaled.jpg)
...
![Meraki switch ports showing the 40GB aggregate trunks labeled CISCO FI-A and CISCO FI-B](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-014-meraki-ports-ucs-fi-trunks-scaled.jpg)
...
![Meraki MX deployment settings set to Routed mode with MAC-address client tracking](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-015-mx-deployment-mode-routed-scaled.jpg)

![Meraki MX VLAN and subnet list including NSX32, NSX42, NSX44, and OTS_EXT](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-016-mx-vlan-svi-list-scaled.jpg)

Before any routing changes, the MX had **no** static routes — there was no path to the VPC external range yet:

![Meraki MX Addressing and VLANs page showing no configured static routes](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-017-mx-no-static-routes-yet-scaled.jpg)
...
![Meraki MX DHCP configuration for VLAN 44 (NSX44) with a reserved range .2 to .14](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-018-mx-dhcp-vlan44-reserved-scaled.jpg)

![Meraki MX DHCP configuration for VLAN 42 (NSX42) with a reserved range .2 to .15](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-019-mx-dhcp-vlan42-reserved-scaled.jpg)
...
![Meraki MX Add Static Route modal for NSX-VPC-External, subnet 10.103.50.0/24, next hop 10.103.44.11](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-022-mx-static-route-add-modal-scaled.jpg)

![Meraki MX static routes list showing NSX-VPC-External 10.103.50.0/24 via 10.103.44.11](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-023-mx-static-route-created-scaled.jpg)
...
![Meraki switch Routing and DHCP page, empty before any L3 interfaces or static routes are added](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-025-switch-routing-empty-scaled.jpg)

I gave the stack a route to the VPC-external range as well, so the jumbo island has its own path:

![Meraki switch static route editor filled in for NSX-VPC-External 10.103.50.0/24 via 10.103.44.11](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-030-switch-static-route-filled-scaled.jpg)
...
![Meraki switch interface editor creating the transit VLAN 99 SVI, 10.103.99.0/30, uplink gateway 10.103.99.1](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-031-switch-svi-transit-vlan99-scaled.jpg)
...
![Meraki switch interface editor showing the error: for the first layer 3 interface, parameter defaultGateway is required](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-032-switch-svi-vlan42-defaultgateway-error-scaled.jpg)
...
![Meraki switch routing showing two SVIs: transit VLAN 99 and NSX42 EdgeTEP VLAN 42](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-033-switch-two-svis-99-42-scaled.jpg)

The host TEP VLAN (32) gets a DHCP server *on the stack* so hosts pull TEP addresses from the jumbo island, not the MX:

![Meraki switch VLAN 32 NSX32-HostTEP DHCP server configuration](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-034-switch-vlan32-dhcp-server-scaled.jpg)

![Meraki banner confirming the interface has been created](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-035-switch-svi-created-banner-scaled.jpg)
...
![Meraki switch routing showing all three L3 interfaces on STACK 40GB: VLAN 99 transit, VLAN 42 EdgeTEP, VLAN 32 HostTEP](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-036-switch-three-svis-jumbo-island-scaled.jpg)

**The short version:** jumbo has to be *true on the wire* before NSX will pass its Run Check. The full underlay write-up — every Meraki field and the transit-VLAN trick — lives in the companion underlay post , but the screens above are the load-bearing ones.
...
![NSX Manager editing the external IP block vpc-external-10.103.50.0-24 with External visibility](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-037-nsx-ipblock-external-edit-scaled.jpg)

![NSX Manager editing the private TGW IP block vpc-private-tgw-10.250.0.0-16, a /16 with Private visibility](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-039-nsx-ipblock-private-tgw-edit-scaled.jpg)

When both are in, the list shows them alongside NSX's built-ins:

![NSX Manager IP Address Blocks list showing Day0 Private Tgw Ip Block, vpc-external-10.103.50.0-24, and vpc-private-tgw-10.250.0.0-16](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-040-nsx-ipblocks-all-created-scaled.jpg)
...
![vCenter Transit Gateways tab, Lets Get Started, Default Transit Gateway with Connection None and External Connection Not Set](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-041-wizard-transit-gateways-start-scaled.jpg)
...
![vCenter Transit Gateway Connectivity step with the Span dropdown set to Default Span](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-042-wizard-tgw-connectivity-span-scaled.jpg)

![vCenter wizard with Centralized Connection selected, showing the services it enables](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-043-wizard-centralized-connection-scaled.jpg)
...
![vCenter Networking Prerequisites modal, all checkboxes unchecked, Continue disabled](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-044-wizard-prerequisites-unchecked-scaled.jpg)

![vCenter Networking Prerequisites modal with Select All checked and Continue enabled](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-045-wizard-prerequisites-checked-scaled.jpg)
...
![vCenter Edge Cluster wizard step, empty, with name dc3-mgmt-edge-cl01, Tunnel Endpoint MTU 9000, form factor Large](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-047-wizard-edge-cluster-empty-scaled.jpg)
...
![vCenter Add Node dialog showing a This field is required error on the empty Management CIDR](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-048-addnode1-mgmt-cidr-required-scaled.jpg)
...
![vCenter Add Node Port Group dropdown showing pg-esx-mgmt, pg-vmotion, and pg-vm-mgmt options](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-049-addnode1-portgroup-dropdown-scaled.jpg)

![vCenter Add Node placement showing Resources pool and the VMFS01 datastore](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-054-addnode1-resources-vmfs01-scaled.jpg)
...
![vCenter Add Node with the Uplinks "Use the host overlay network configuration" checkbox highlighted](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-053-addnode1-uplinks-host-overlay-scaled.jpg)
...
![vCenter Add Node showing the TEP IP Pool humbledgeeks-cl01-tep01 selected on VLAN 32](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-055-addnode1-tep-ip-pool-select-scaled.jpg)
...
![vCenter Add Node showing the red Fabric error: Not enough IP address available in the given ip pool, Error code 15000](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-056-addnode1-error-15000-not-enough-ip-scaled.jpg)
...
![NSX Manager IP pool subnet showing two ranges, 10.103.32.2-.9 and 10.103.32.10-.100](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-057-nsx-tep-pool-two-ranges-scaled.jpg)
...
![NSX Manager IP pool subnet edited down to a single range 10.103.32.2-10.103.32.16](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-058-nsx-tep-pool-trimmed-scaled.jpg)
...
![vCenter Add Node Run Check returning a green 4 SUPPORTED HOSTS for the VLAN MTU check](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-059-addnode1-runcheck-4-supported-hosts-scaled.jpg)

First edge node is in the cluster list:

![vCenter Edge Cluster step showing dc3-nsx-edge01 added, 1 Node](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-060-wizard-edge-cluster-node1-added-scaled.jpg)
...
![vCenter Add Node for dc3-nsx-edge02 showing management 10.103.16.139/24 on datastore VMFS01](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-061-addnode2-placement-vmfs01-scaled.jpg)

![vCenter Add Node for edge02 showing TEP VLAN 32 and a passing Run Check](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-062-addnode2-tep-runcheck-scaled.jpg)

Two edges — the active/standby pair a Tier-0 needs for HA. Step 2 is done:

![vCenter Edge Cluster step showing both edge nodes added, 2 Nodes](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-063-wizard-edge-cluster-both-nodes-scaled.jpg)
...
![vCenter Workload Domain Connectivity step with BGP toggled On, exposing a required Local ASN field](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-065-wdc-bgp-on-local-asn-scaled.jpg)

Toggle BGP **off**, name the gateway `dc3-mgmt-t0-gw01`, HA mode **Active/Standby**:

![vCenter Workload Domain Connectivity step with BGP Off and the Tier-0 gateway named dc3-mgmt-t0-gw01](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-066-wdc-bgp-off-top-scaled.jpg)
...
![vCenter edge01 Gateway Uplinks modal: VLAN 44, interface CIDR 10.103.44.11/24](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-067-wdc-edge1-uplink-44-11-scaled.jpg)

![vCenter edge02 Gateway Uplinks modal: VLAN 44, interface CIDR 10.103.44.12/24](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-069-wdc-edge2-uplink-44-12-scaled.jpg)
...
![vCenter VPC External IP Blocks field showing No items Found when a CIDR is typed directly](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-071-wdc-external-block-no-items-found-scaled.jpg)
...
![vCenter Private Transit Gateway IP Blocks dropdown showing Day0 Private Tgw Ip Block and the custom vpc-private-tgw-10.250.0.0-16](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-073-wdc-private-tgw-block-dropdown-scaled.jpg)

With the Tier-0 named, BGP off, both uplinks set, and both VPC blocks selected, Step 3 is complete:

![vCenter Workload Domain Connectivity step complete: dc3-mgmt-t0-gw01, Active Standby, BGP Off, both edge uplinks, and both VPC IP blocks selected](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-074-wdc-complete-t0-both-blocks-scaled.jpg)
...
![vCenter Review and Deploy summary showing the edge cluster and workload domain connectivity details](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-077-review-and-deploy-summary-scaled.jpg)
...
![vCenter Transit Gateways tab showing the connectivity request submitted and deployment In Progress](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-079-deploy-submitted-banner-scaled.jpg)
...
![vCenter Recent Tasks showing two Deploy OVF template tasks for the edge nodes at about 32 to 34 percent](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-080-deploy-ovf-progress-scaled.jpg)
...
![vCenter Edge Clusters showing the cluster Success with node connectivity still 2 Not Available](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-082-edge-cluster-success-connectivity-pending-scaled.jpg)

![vCenter Edge Clusters showing dc3-mgmt-edge-cl01 with 2 Up and Success](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-083-edge-cluster-2-up-success-scaled.jpg)
...
![NSX Manager Tier-0 Gateways list showing dc3-mgmt-t0-gw01 in Success with 1 linked transit gateway](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-084-t0-list-success-scaled.jpg)
...
![NSX Manager Set Static Routes modal, empty](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-086-static-routes-empty-scaled.jpg)

![NSX Manager adding the default-route-to-mx static route for 0.0.0.0/0](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-088-add-route-default-route-to-mx-scaled.jpg)

Click **Set** next to Next Hops and enter the MX SVI on VLAN 44 — IP `10.103.44.1`, Admin Distance `1`:

![NSX Manager Set Next Hops modal entering 10.103.44.1 with admin distance 1](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-089-next-hop-44-1-entry-scaled.jpg)
...
![NSX Manager static route default-route-to-mx added, status Uninitialized](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-091-route-added-uninitialized-scaled.jpg)

![NSX Manager static route default-route-to-mx, 0.0.0.0/0, status Success](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-092-route-success-scaled.jpg)
...
![NSX Manager Set HA VIP Configuration entering 10.103.44.10/24 across both External-interface44 uplinks, Enabled Yes](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-097-ha-vip-entry-44-10-scaled.jpg)
...
![NSX Manager Tier-0 dc3-mgmt-t0-gw01 showing HA mode Active Standby with one HA VIP configured](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-099-t0-ha-active-standby-vip-scaled.jpg)
...
![NSX Manager Edit External Connection form for Gateway-connection-dc3-mgmt-t0-gw01, Centralized, SNAT off](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-101-extconn-form-snat-off-scaled.jpg)
...
![NSX Manager External Connection with Provider Outbound SNAT On and the External IP Block set to vpc-external-10.103.50.0-24](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-104-extconn-snat-on-external-block-scaled.jpg)
...
![NSX Manager External Connection fully configured: Provider Outbound SNAT On with vpc-external block for both External and SNAT IP Blocks](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-105-extconn-snat-configured-scaled.jpg)
...
![Meraki MX Modify Static Route changing the NSX-VPC-External next hop to the VIP 10.103.44.10](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-107-mx-route-flip-to-vip-scaled.jpg)
...
![NSX Manager Default Transit Gateway up and linked to the external connection, status Success](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-110-tgw-up-linked-success-scaled.jpg)

![NSX Manager External Connection Gateway-connection-dc3-mgmt-t0-gw01 in Success](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-111-extconn-success-scaled.jpg)
...
![NSX Manager Overview after the build: 1 Tier-0 Gateway, 1 External Connection, 1 Transit Gateway, 2 Segments, 1 Edge Cluster](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-113-nsx-overview-after-scaled.jpg)

All four hosts are prepared for NSX in `humbledgeeks-cl01`:

![NSX Manager Fabric Hosts showing all four ESXi hosts Up and Prepared in humbledgeeks-cl01](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-114-hosts-4-prepared-scaled.jpg)
...
![NSX Manager Edges showing dc3-mgmt-edge-cl01 with both nodes Up, Success, and 4 tunnels each](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-115-edge-cluster-tunnels-up-scaled.jpg)
...
![VCF workload domain wizard vSphere Supervisor step with Default VPC Connectivity Profile selected, all fields populated, and NEXT enabled](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf91-wld-116-supervisor-vpc-profile-selected-scaled.jpg)
