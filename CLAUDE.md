# Claude Context - zero-to-vcap

## Project Purpose

Documenting Allen's journey from zero to VMware Cloud Foundation (VCF) VCAP-VCF Administrator certification. This repo serves as the companion to the "Zero to VCAP" blog series on HumbledGeeks.com.
...
- **Exam**: VCAP-VCF Administrator (Broadcom Knight Journey)
- **Timeline**: 6-7 month study plan starting February 2026
