...
- [ ] **ESXi installed, hardened, and certificates regenerated** on all four hosts so they match their final FQDNs. This is the exact same prep I documented in the [VCF 9.1 deployment post](https://humbledgeeks.com/)  — my PowerShell hardening and cert-regen scripts — so I won't re-walk it here.
...
![SDDC Manager dashboard showing a single management workload domain and four hosts in use before commissioning](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-01-dashboard-before-scaled.jpg)
...
![Commission Hosts prerequisite checklist with all items unchecked](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-02-checklist-blank-scaled.jpg)
...
![Commission Hosts checklist with every item acknowledged and Proceed enabled](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-03-checklist-acknowledged-scaled.jpg)
...
![Add host form with FQDN dc3-hst-esxi05, Storage Type set to VMFS on FC, and network pool selected](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-04-add-host-vmfs-fc-scaled.jpg)
...
![First host added to the list, SHA256 thumbprint displayed, validation status Not Validated](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-05-first-host-added-scaled.jpg)
...
![All four hosts added with fingerprints confirmed, awaiting validation](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-06-four-hosts-added-scaled.jpg)
...
![Host validation in progress for the four staged hosts](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-07-validation-in-progress-scaled.jpg)
...
![All four hosts validated successfully with green Valid status](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-08-hosts-validated-scaled.jpg)
...
![Validation complete, all four hosts marked Valid and ready to proceed](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-09-validation-complete-scaled.jpg)

With all four valid, **Next** lights up.

![Commission review step showing the four validated hosts with VMFS_FC storage type and the skip-failed-hosts toggle](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-10-review-commission-scaled.jpg)
...
![Unassigned Hosts tab showing the four new hosts activating with a Need Cleanup status](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-11-unassigned-activating-scaled.jpg)
...
![Unassigned Hosts tab showing the four new hosts now Active and unassigned](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-12-unassigned-active-scaled.jpg)
...
![Assigned Hosts tab showing the four management-domain hosts esxi01 through esxi04](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-13-assigned-hosts-mgmt-scaled.jpg)
...
![Assigned Hosts detail view of the management hosts with FC storage and active status](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-14-assigned-hosts-detail-scaled.jpg)

A closer look at those assigned hosts — all Active, all FC, all part of the management cluster.

![SDDC Manager dashboard after commissioning showing eight hosts total with four unallocated](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-commission-15-dashboard-after-scaled.jpg)
...
![Workload Domain wizard General Information step with name dc3-wld01, Full deployment with cluster selected, and Enable vSphere Supervisor toggled on](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-01-general-info-supervisor-scaled.jpg)
...
![vCenter step showing FQDN dc3-vc02.humbledgeeks.com and the vCenter Single Sign-On note about creating an isolated workload domain](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-02-vcenter-sso-scaled.jpg)
...
![Cluster step with cluster name dc3-wld-cl01 and vSphere Zone name dc3-zone1](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-03-cluster-scaled.jpg)
...
![Image step selecting the Management-Domain-ESXi-Personality vLCM image at ESXi 9.1.0.0100](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-04-image-scaled.jpg)
...
![NSX Manager step with Join existing NSX Manager instance selected, pointing at dc3-nsx01, and warnings that the instance is shared and VPCs will span domains](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-05-nsx-join-existing-scaled.jpg)
...
![Storage step with VMFS on FC selected and datastore name VMFS01](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-06-storage-vmfs-fc-scaled.jpg)
...
![Select Hosts step showing the four commissioned blades selected for the new cluster](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-07-select-hosts-scaled.jpg)
...
![Distributed Switch step showing the Default and NSX Traffic Separation preconfigured profiles, with NSX Traffic Separation selected](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-08-vds-profile-select-scaled.jpg)
...
![Distributed Switch step showing two switches wld-cls-vds-01 and wld-cls-vds-02 with a warning that the Transport VLAN must be edited](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-09-vds-switches-scaled.jpg)
...
![Distributed Switch detail showing MTU 9000, PNICs vmnic2 and vmnic3, NSX overlay transport zone, Transport VLAN 32, and TEP IP assignment by DHCP](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-10-vds-transport-vlan-scaled.jpg)
...
![vSphere Supervisor step showing supervisor name, service CIDR, management network settings, control plane IP range, and the Virtual Private Cloud Network section](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-11-supervisor-config-scaled.jpg)
...
![vSphere Supervisor step with the VPC Connectivity Profile dropdown highlighted, showing Default VPC Connectivity Profile selected](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-12-vpc-connectivity-profile-scaled.jpg)
...
![Workload Domain Review summary showing domain name dc3-wld01, cluster dc3-wld-cl01, image, vCenter details, and SSO Domain Option set to Creating new SSO domain](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-13-review-summary-scaled.jpg)
...
![Validation step with validation in progress spinner](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-14-validation-in-progress-scaled.jpg)

**Step 11 — Validation** kicks off the pre-flight checks.

![Validation step showing five checks all succeeded: platform infrastructure state, platform storage state, management VMs, DNS and NTP servers, and domain creation specification](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-15-validation-succeeded-scaled.jpg)
...
![Validation complete, initiating workload domain creation](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-16-initiating-creation-scaled.jpg)

All checks pass, I hit **Finish**, and SDDC Manager initiates the build.

## Phase 13 — Deploy: Watching the Workload Domain Come Up

![Workload Domains view with the Creating Workload Domain dc3-wld01 task at 4 percent performing validations](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-17-deploy-validations-scaled.jpg)
...
![Creating Workload Domain task at 25 percent deploying the vCenter Server virtual appliance](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-18-deploy-vcenter-scaled.jpg)

At 25%, it's deploying the **vCenter Server appliance** — `dc3-vc02` coming to life.

![Creating Workload Domain task at 42 percent uploading the vSphere Lifecycle Manager image to vCenter](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-19-deploy-vlcm-image-scaled.jpg)
...
![SDDC Manager dashboard showing two workload domains, eight hosts all in use, and a task activating the Supervisor](https://humbledgeeks.com/wp-content/uploads/2026/06/vcf-wld-create-20-two-workload-domains-scaled.jpg)
...
And if you skipped ahead because *your* VPC Connectivity Profile dropdown was empty too — go read **[Building the NSX Spine](https://humbledgeeks.com/)** . That detour is the bridge between this post and a Supervisor that actually activates.
