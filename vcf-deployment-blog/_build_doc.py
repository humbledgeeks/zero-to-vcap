#!/usr/bin/env python3
"""
Build VCF-9.1-Deployment-ImageFlow.docx as a faithful render of the blog post
(blog-posts/zero-to-vcap-vcf91-deployment.md): intro + URLs + expanded captions
+ tip callouts + all 78 images.

Images are already renamed in place (see image-rename-map.csv); this script only
renders. Run from the repo root:

    .venv/bin/python vcf-deployment-blog/_build_doc.py
"""
import re
...
DOCX_OUT = Path(__file__).resolve().parent / "VCF-9.1-Deployment-ImageFlow.docx"
